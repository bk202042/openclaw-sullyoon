---
title: "ACP & acpx — 에이전트 간 통신 프로토콜 완전 정리"
description: "OpenClaw ACP(Agent Client Protocol) 브릿지와 acpx headless CLI client의 개념, 차이, 활용법을 단계별로 정리한 핵심 레퍼런스"
tags: [acp, acpx, agent-protocol, multi-agent, openclaw, codex, claude-code, headless-cli]
trigger: "에이전트 연동, ACP 브릿지, acpx, 코딩 에이전트 위임, PTY 대체, 멀티에이전트 워크플로우"
created: "2026-03-11"
version: "3.8"
status: "active"
---
